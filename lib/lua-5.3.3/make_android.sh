...
mkdir -p lib_android/armeabi-v7a/
cp build_v7a/liblua.a lib_android/armeabi-v7a/liblua.a
rmdir -r build_v7a
...
mkdir -p lib_android/x86/
cp build_x86/liblua.a lib_android/x86/liblua.a
rmdir -r build_x86
